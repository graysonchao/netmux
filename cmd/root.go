...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.udpmux.yaml)")
...
func initConfig() {
	viper.SetConfigName(".udpmux") // name of config file (without extension)
